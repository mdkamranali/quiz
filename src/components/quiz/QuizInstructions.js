        ...
        <div className="instructions container">
            ...
            <ul className="browser-default" id="main-list">
                ...
                <li>
                    ...
                    <img src="https://github.com/barman47/quiz-app/blob/master/src/assets/img/options.PNG?raw=true" alt="Quiz App options example" />
                </li>
                <li>
                    Select the option which best answers the question by clicking (or selecting) it.
                    <img src="https://github.com/barman47/quiz-app/blob/master/src/assets/img/answer.png?raw=true" alt="Quiz App answer example" />
                </li>
                <li>
                ...
                <li>
                    ...
                    <img src="https://github.com/barman47/quiz-app/blob/master/src/assets/img/fiftyFifty.PNG?raw=true" alt="Quiz App Fifty-Fifty example"/>
                </li>
                <li>
                    ...
                    <img src="https://github.com/barman47/quiz-app/blob/master/src/assets/img/hints.PNG?raw=true" alt="Quiz App hints example" />
                </li>
